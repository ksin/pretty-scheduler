...
test('serializes date strings into ISO 8601', function(assert) {
  ...
  let result = transform.serialize(moment.utc("2014-02-05", "YYYY-MM-DD", true));
  assert.equal(result, "2014-02-05T00:00:00.000Z");
});
...
test('deserializes into a moment', function(assert) {
  let transform = UtcTransform.create();
  let result = transform.deserialize("2014-02-05T00:00:00.000Z");
